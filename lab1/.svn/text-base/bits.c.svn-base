...
int exp=(1<<31)>>31;
int result=((exp<<highbit)<<1)^(exp<<lowbit);
result=result&(exp<<lowbit);
return result;
}
/* 
...
int exp=x|(x>>16);
int exp1=exp|(exp>>8);
int exp2=exp1|(exp1>>4);
int exp3=exp2|(exp2>>2);
int exp4=exp3|(exp3>>1);
int result=(exp4&1)^1;  
return result;
}
/* 
...
int mask=0xff;
int exp1=(x>>24)& mask;
int exp2=((x>>16) & mask)<<8;
int exp3=((x>>8) & mask)<<16;
int exp4=(x&mask)<<24;
int result=exp1|exp2|exp3|exp4;
return result;
}
/* 
